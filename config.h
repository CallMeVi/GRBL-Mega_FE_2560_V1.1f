...
#define DEFAULTS_CNC_FE_V                 //MOD: @Call_Me_V
#define CPU_MAP_2560_CNC_FE_V             //MOD: @Call_Me_V
...
//#ifdef DEFAULTS_RAMPS_BOARD                                       //MOD: @Call_Me_V
//  #define HOMING_CYCLE_0 (1<<X_AXIS)   // Home X axis             //MOD: @Call_Me_V
//  #defi//ne HOMING_CYCLE_1 (1<<Y_AXIS)   // Home Y axis           //MOD: @Call_Me_V
//  #define HOMING_CYCLE_2 (1<<Z_AXIS)   // OPTIONAL: Home Z axis   //MOD: @Call_Me_V
//#else
  #define HOMING_CYCLE_0 (1<<Z_AXIS)                // REQUIRED: First move Z to clear workspace.
  #define HOMING_CYCLE_1 ((1<<X_AXIS)|(1<<Y_AXIS))  // OPTIONAL: Then move X,Y at the same time.
  // #define HOMING_CYCLE_2                         // OPTIONAL: Uncomment and add axes mask to enable
//#endif // DEFAULTS_RAMPS_BOARD                                    //MOD: @Call_Me_V
